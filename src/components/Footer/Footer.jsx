...
const linkCls = 'text-[0.875rem] text-onsurface-600 no-underline transition-[color_150ms_ease] hover:text-gold';
const legalCls = 'text-[0.8rem] text-onsurface-600 no-underline transition-[color_150ms_ease] hover:text-onsurface-100';

export default function Footer() {
  return (
    <footer className="bg-surface-900 border-t border-line">
      <div className="container grid grid-cols-[2fr_1fr_1fr_1.5fr] gap-12 pt-16 pb-12 items-start max-[1024px]:grid-cols-2 max-[600px]:grid-cols-1 max-[600px]:gap-8">
        ...
        <div className="flex flex-col gap-2">
          <Link to="/" className="flex items-center gap-3 no-underline -mt-[60px]">
            <img src={logo} alt="Sports Hub" className="h-[130px] w-auto object-contain" />
          </Link>
          <p className="text-[0.8rem] text-onsurface-600 leading-[1.7] max-w-[260px]">
          ...
          <div className="flex gap-3 mt-6 mb-6">
            <a
              ...
              className="w-9 h-9 bg-surface-600 border border-line rounded-[6px] flex items-center justify-center text-onsurface-400 transition-[background_150ms_ease,border-color_150ms_ease,color_150ms_ease] no-underline hover:bg-red hover:border-red hover:text-light-100"
            >
        ...
        {/* Quick links */}
        <div>
          <h4 className="text-[11px] font-bold tracking-[2px] uppercase text-gold-muted mb-5">Sports Hub</h4>
        ...
        <div>
          ...
          <ul className="flex flex-col gap-3">
            <li className="text-[0.875rem] text-onsurface-600 leading-[1.6]">+92 334 6688701</li>
            <li className="text-[0.875rem] text-onsurface-600 leading-[1.6]">+92 314 7512811</li>
            <li className="text-[0.875rem] text-onsurface-600 leading-[1.6]">sportshub@gmail.com</li>
            <li className="text-[0.875rem] text-onsurface-600 leading-[1.6]">Islamabad, Pakistan</li>
          </ul>
        </div>
      </div>
      ...
      <div className="border-t border-line py-5">
        <div className="container flex justify-between items-center gap-4 flex-wrap max-[600px]:flex-col max-[600px]:text-center">
          <p className="text-[0.8rem] text-onsurface-600">
            © 2025 Sports Hub. All rights reserved.
          </p>
