      ...
      <div className="container footer__top">
        ...
        <div className="footer__brand">
          <Link to="/" className="footer__logo">
            <img src={logo} alt="Kit Lab" className="footer__logo-img" />
          </Link>
          <p className="footer__tagline">
            Premium custom sports kits for teams and individuals. Play with passion.
          </p>
          <div className="footer__socials">
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="footer__social">
            ...
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="footer__social">
            ...
            <a href="https://x.com" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)" className="footer__social">
        ...
        <div className="footer__col">
          <h4 className="footer__col-title">Kit Lab</h4>
        ...
        <div className="footer__col">
          ...
          <ul className="footer__links">
            <li><Link to="/kits">Cricket</Link></li>
            <li><Link to="/kits">Football</Link></li>
            <li><Link to="/kits">Basketball</Link></li>
            <li><Link to="/kits">Training</Link></li>
          </ul>
        </div>
        ...
        <div className="footer__col">
          ...
          <ul className="footer__links footer__links--plain">
            <li>+92 334 6688701</li>
            <li>+92 314 7512811</li>
            <li>kitlab@gmail.com</li>
