...
export default function Hero() {
  return (
    <section className="relative min-h-screen bg-bg-800 flex items-center overflow-hidden pt-[72px]">
      <div
      ...
      <div className="container flex flex-col items-center text-center pt-16 pb-16 w-full">
        <div className="flex flex-col items-center gap-5 z-[1] max-w-[780px]">
          <h1 className="animate-[heroSlideUp_0.7s_cubic-bezier(0.22,1,0.36,1)_0.05s_both] flex flex-col leading-none mt-1">
            <span className="font-display text-[clamp(3.5rem,9vw,8rem)] text-light-100 tracking-[4px] uppercase max-[600px]:text-[clamp(3rem,14vw,5rem)]">PLAY WITH</span>
          ...
          <p className="animate-[heroSlideUp_0.7s_cubic-bezier(0.22,1,0.36,1)_0.15s_both] text-[1.05rem] text-light-500 max-w-[520px] leading-[1.75]">
